      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 min-h-screen flex flex-col justify-center pt-20 pb-24">
        <div className="animate-hero-fade-in max-w-2xl">
          ...
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[0.95] tracking-tight text-white mb-6 sm:mb-8">
            {t("hero.line1")}
            <br />
            <span className="italic text-stone-300">{t("hero.line2")}</span>
            <br />
            {t("hero.line3")}
          </h1>
          ...
          <div className="mt-12 sm:mt-16 flex gap-8 sm:gap-12">
            {[
              ...
              { value: "500+", label: t("hero.clients") },
              { value: "5.0", label: t("hero.reviews") },
            ].map((stat) => (
              <div key={stat.label}>
        ...
        <div className="hidden lg:block absolute right-8 rtl:right-auto rtl:left-8 xl:right-16 rtl:xl:right-auto rtl:xl:left-16 bottom-32 bg-white/10 backdrop-blur-md border border-white/20 p-5 max-w-[200px] animate-hero-slide-right">
          <p className="text-xs tracking-widest uppercase text-stone-300 mb-1">{t("hero.walkIns")}</p>
          <p className="font-display text-lg font-semibold text-white">{t("hero.alwaysWelcome")}</p>
