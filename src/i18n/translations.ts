...
const en: Dict = {
  ...
  "hero.subtitle": "Walk-ins welcome. Skilled barbers, attention to every detail, and the kind of confidence you carry long after you leave the chair.",
...
const es: Dict = {
  ...
  "hero.subtitle": "Sin cita previa. Barberos expertos, atención a cada detalle y la confianza que llevas contigo mucho después de levantarte de la silla.",
...
const ar: Dict = {
  ...
  "hero.subtitle": "بدون موعد مسبق. حلاقون محترفون، اهتمام بكل تفصيل، وثقة ترافقك طويلاً بعد مغادرة الكرسي.",
